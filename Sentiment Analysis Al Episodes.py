...
PodcastName = "Shameless"

data = pd.read_csv("C:/Users/ruari/Google Drive (ruari@whalepodanalytics.com)/Podcast AI/Transcribed Podcasts/" + PodcastName + "/Transcript.csv", quotechar='"', engine='python')#, engine='python' 
...
for index, row in dfcsv.iterrows():
    ...
    try:
        ...
        print(epTitle + " error")
summarydf.to_csv(r'C:/Users/ruari/Google Drive (ruari@whalepodanalytics.com)/Podcast AI/Transcribed Podcasts/' + PodcastName + '/Sentiment_Analysis.csv', index = False)
